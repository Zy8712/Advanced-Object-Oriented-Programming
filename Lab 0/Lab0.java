...
/////////////Exercise 7//////////////		
	...
	public static int flipBit(int x) {
		if (x == 1) {
			...
			throw new BadBitException("Invalid input");
		}
	}
...
/////////////Exercise 11//////////////		
	...
	public static String toString(Range r) {
		double x = r.getMinimum();
		double y = r.getMaximum();
		return "range from " + x + " to " + y;
	}
...
/////////////Exercise 13//////////////		
	...
	public static String alternatingCaps(String s) {
		char[] c = s.toCharArray(); // Iterate over characters
		for (int i = 0; i < c.length; i++) {
			if (i % 2 != 0) // check if position of this character is odd
			{
				c[i] = Character.toUpperCase(c[i]); // convert it to upper case
			} else {
				c[i] = Character.toLowerCase(c[i]); // convert it to lower case
			}
		}
